 ...
 */
public class Alerta15Min  extends WakefulBroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            notif = new Notification.Builder(context).setContentTitle("Faltan 15 min para el turno de : " + cliente.getNombre()).
